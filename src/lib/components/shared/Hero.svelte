...
>
	...
	<div class="absolute inset-0 pointer-events-none">
		<div
			class="absolute -top-40 -left-40 w-[600px] h-[600px] rounded-full bg-primary/[0.06] blur-[120px] animate-float"
		></div>
		<div
			class="absolute -bottom-40 -right-40 w-[500px] h-[500px] rounded-full bg-secondary/[0.04] blur-[100px] animate-float-slow"
		></div>
		<div
			class="absolute top-1/3 right-1/4 w-[300px] h-[300px] rounded-full bg-primary/[0.04] blur-[80px] animate-float"
	...
	<div class="absolute inset-0 pointer-events-none flex items-center justify-center">
		<div
			class="absolute w-[500px] h-[500px] rounded-full border border-primary/[0.07] animate-spin-slow"
		></div>
		<div
			class="absolute w-[700px] h-[700px] rounded-full border border-secondary/[0.04] animate-spin-slow"
			style="animation-direction: reverse; animation-duration: 30s;"
		></div>
		<!-- Orbit dot -->
		<div
			class="absolute w-3 h-3 rounded-full bg-primary shadow-[0_0_10px_rgba(207, 109, 70,0.8)] animate-spin-slow"
	...
	<div class="relative z-10 container-max section-padding text-center">
		...
		>
			{#each ['SvelteKit', 'TypeScript', 'IoT', 'Laravel', 'PostgreSQL', 'Node.js', 'React', 'Flutter'] as tech}
				<span
					class="px-3 py-1.5 text-xs font-mono text-slate-text/70 border border-white/[0.06] rounded-full hover:text-primary hover:border-primary/30 transition-all duration-300 cursor-default"
				>
					{tech}
				</span>
			{/each}
